...
public class UserController {
	...
	public String register(Model model){
		model.addAttribute("userDTO", new LoginUser());
		model.addAttribute("roleList",userService.getUserRole());
		return "register";
	}
	@RequestMapping(value="/register",method=RequestMethod.POST)
	public String postRegister(@ModelAttribute(value="userDTO")LoginUser userDTO ){
